...
class DecoratorClass(object):
    ...
    def __call__(self, *args, **kwargs):
        print(
            f"The wrapper class executed and printed this before {self.original_function.__name__}"
        )
...
@logger_decorator
@timing_decorator
def display_info_full(age: int, name: str):
    """This a docstring for 'display_info_full' function"""

    # displays people name and age
    print(f"Age: {age}, Name: {name}")


# display_info_full(34, 'Anna')
...
def decorator_with_args(param):
    def logger_decorator(original_func):
        def wrapper(*args, **kwargs):
            """This a docstring for logger_decorator wrapper function"""
...
# Without @wraps all info will be displayed for the wrapper itself
# help(display_info)
print(display_info.__name__)
print(display_info.__doc__)


# With @wraps all info will be displayed for the original function passed to decorator
# help(display_info_full)
print(display_info_full.__name__)
print(display_info_full.__doc__)
